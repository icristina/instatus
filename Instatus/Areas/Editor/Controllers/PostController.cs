...
{
    public class PostViewModel : BaseViewModel<Post, IApplicationContext>
    {
        [Category("Overview")]
        [Display(Order = 1)]
    ...
    [Description("Posts")]
    public class PostController : ScaffoldController<PostViewModel, Post, IApplicationContext, int>
    {
